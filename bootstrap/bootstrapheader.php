...
<html lang="en">
	<head>
		...
		<title>Harry Van Bavel - Bootstrap</title>
		...
		<div class="container">
			<div id="carousel1" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active"><img src="afbeeldingen/engeland1.jpg" alt="Foto 1"></div>
			...
			<div class="navbar" role="navigation">
				...
				<div id="menu" class="navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="registratielijst.php">Registratielijst</a></li>
					</ul>
				</div>
			</div>
