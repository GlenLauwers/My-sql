...
$sql="SELECT voornaam, familienaam, datum, onderwerp, inhoud, forum_bootstrap.id FROM gebruikers_bootstrap INNER JOIN forum_bootstrap ON gebruikers_bootstrap.id = forum_bootstrap.id_gebruikers ORDER BY datum";
...
if ($actie == 'invullen'){
  ...
  if (isset($_POST['verstuur'])){
    ...
    $boodschap = $db->real_escape_string($_POST['boodschap']);
  }
  else {
